...
public final class ProcessRestrictions {
     ...
     * point rather than inside {@link #apply}. No-op when null.
     */
    public static void applyOomScoreAdj(Integer oomScoreAdj) {
    ...
    public static void apply(Spec.Process process, Spec.LinuxSeccomp seccomp,
        ...
        boolean nnpRequested = process != null
                && Boolean.TRUE.equals(process.noNewPrivileges);

        if (process != null && process.apparmorProfile != null) {
            AppArmor.apply(process.apparmorProfile);
        }
        if (process != null && process.selinuxLabel != null) {
        ...
        Spec.LinuxCapabilities caps = process != null ? process.capabilities : null;
        if (caps != null) {
        ...
        if (process != null && process.user != null
                && process.user.additionalGids != null) {
            Groups.setAdditional(process.user.additionalGids);
        }

        int targetGid = process != null && process.user != null ? process.user.gid : 0;
        int targetUid = process != null && process.user != null ? process.user.uid : 0;
